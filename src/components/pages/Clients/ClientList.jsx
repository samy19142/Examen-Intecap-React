...
console.log(rows)
  ...
  const deleteApi = async (id) => {
    ...
    getClients; // actualizar la lista de usuarios
  };
  ...
  const editData = (id, nombre, email, direccion,telefono) => {
  ...
  return (
    <>
      <div>
        ...
        >
          <Box sx={style}>
            <EditClient closeEvent={handleEditClose} fid={formid} />
          </Box>
        </Modal>
      </div>
        ...
        <Paper sx={{ width: '98%', overflow: 'hidden', padding: "12px" }}>
          ...
          <Stack direction="row" spacing={2} className="my-2 mb-2">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} size="small" label="Buscar Cliente" />
              )}
            />
            <Typography
              variant="h6"
                        ...
                        <TableCell align="left">
                          <Stack spacing={2} direction="row">
                            <EditIcon
                              ...
                              onClick={() =>
                                editData(row.id, row.nombre, row.email, row.direccion,row.telefono)
                              }
                            />
                            <DeleteIcon
                              style={{
